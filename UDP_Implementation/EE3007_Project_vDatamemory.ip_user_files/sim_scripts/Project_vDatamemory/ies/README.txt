...
#
# Generated by export_simulation on Mon Jan 09 15:35:55 +0300 2023
#
################################################################################
...
'-reset_run' switch to the './Project_vDatamemory.sh' script.

./Project_vDatamemory.sh -reset_run
...
./Project_vDatamemory.sh -noclean_files

For more information on the script, please type './Project_vDatamemory.sh -help'.
