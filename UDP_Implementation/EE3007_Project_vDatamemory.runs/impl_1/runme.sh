...
HD_PWD='C:/Users/SFG/EE3007_Project_vDatamemory/EE3007_Project_vDatamemory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_vDatamemory_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Project_vDatamemory_wrapper.tcl -notrace
