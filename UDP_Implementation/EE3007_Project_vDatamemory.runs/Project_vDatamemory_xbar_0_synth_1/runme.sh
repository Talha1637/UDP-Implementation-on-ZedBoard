...
HD_PWD='C:/Users/SFG/EE3007_Project_vDatamemory/EE3007_Project_vDatamemory.runs/Project_vDatamemory_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_vDatamemory_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Project_vDatamemory_xbar_0.tcl
