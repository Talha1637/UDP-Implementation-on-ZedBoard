...
HD_PWD='C:/Users/SFG/Datapath_IP_vDataMemoryInit/ip_repo/edit_Datapath_IP_vDataMemoryInit_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Datapath_IP_vDataMemoryInit_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Datapath_IP_vDataMemoryInit_v1_0.tcl
